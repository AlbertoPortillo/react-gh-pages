...
export default function Inicio() {
    ...
    function handleSubmit(e: any){
        ...
        alert('nos presentamos con fallas tecnicas por lo cual no podremos completar su solicitud')
    }
    ...
    return (
        <div className='container-fluid mb-5 mt-5'>
            ...
            <div className="row">
                <p className='text-bits contactme-text-body'>
                    Si estas interesado en mi perfil y llegaste a esta website al azar, bueno, pon un pequeño mensaje y prometo,
                    que lo mas pronto posible yo me podnre en contacto contigo para hablar de lo que necesites. 
                </p>
            </div>
